...
RULES = {
    ...
    'dtls13_ku_sent_epoch': ssl_session_reset_check.ResetBehavior.RESET,
    'dtls13_ku_acked': ssl_session_reset_check.ResetBehavior.RESET,
    'dtls13_peer_post_hs_closed_epoch': ssl_session_reset_check.ResetBehavior.RESET,
    'dtls13_peer_post_hs_closed_valid': ssl_session_reset_check.ResetBehavior.RESET,
