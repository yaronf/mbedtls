...
**Last updated:** 2026-03-25 (updated after Phase 3a.10)
**Branch:** `dtls13`
...
| DTLS 1.3: amplification limit | 3b.2 | Server refuses to send > 3x bytes before address validated |
| DTLS 1.3: ACK sent for final client flight | 3b.4 | Server debug log shows ACK transmitted |
